...
class Bn256KeyedSignature extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Bn256KeyedSignature',
  ...
  static PbList<Bn256KeyedSignature> createRepeated() =>
      PbList<Bn256KeyedSignature>();
  static Bn256KeyedSignature getDefault() => _defaultInstance ??=
      GeneratedMessage.$_defaultFor<Bn256KeyedSignature>(create);
  ...
  @override
  factory Bn256KeyedSignature.fromBuffer(List<int> i,
          [ExtensionRegistry r = ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  @override
  factory Bn256KeyedSignature.fromJson(String i,
          [ExtensionRegistry r = ExtensionRegistry.EMPTY]) =>
  ...
  @TagNumber(1)
  set signature(Bn256Signature v) {
    setField(1, v);
  }
  ...
  @TagNumber(2)
  set publicKey(Bn256PublicKey v) {
    setField(2, v);
  }
