...
class CheckpointVRF extends GeneratedMessage {
  ...
  static CheckpointVRF getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<CheckpointVRF>(create);
  ...
  @override
  CheckpointVRF copyWith(void Function(CheckpointVRF) updates) => super.copyWith((message) => updates(message as CheckpointVRF)) as CheckpointVRF; // ignore: deprecated_member_use
  ...
  @override
  factory CheckpointVRF.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);

  @override
  factory CheckpointVRF.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  @TagNumber(2)
  set hashPrevVrf(Hash v) { setField(2, v); }
  @TagNumber(2)
