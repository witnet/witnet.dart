...
class PublicKey extends GeneratedMessage {
  ...
  static PublicKey getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<PublicKey>(create);
  ...
  @override
  factory PublicKey.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
