...
class ValueTransferOutput {
  ...
  factory ValueTransferOutput.fromJson(Map<String, dynamic> json) => ValueTransferOutput(
  ...
  Uint8List get pbBytes {
    List<int> _timeLock = [];
    if(timeLock > 0){
      _timeLock = concatBytes([varInt(BigInt.from(24)), varInt(BigInt.from(timeLock))]).toList();
    }
    var content = concatBytes([pkh.pbBytes, indexHeader, varInt(BigInt.from(value)), Uint8List.fromList(_timeLock)]);
