...
class RADAggregate extends GeneratedMessage{
  ...
  static RADAggregate getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<RADAggregate>(create);
  ...
  @override
  RADAggregate copyWith(void Function(RADAggregate) updates) => super.copyWith((message) => updates(message as RADAggregate)) as RADAggregate; // ignore: deprecated_member_use
  ...
  @override
  factory RADAggregate.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);

  @override
  factory RADAggregate.fromRawJson(String str) => RADAggregate.fromJson(json.decode(str));
  ...
  RADAggregate setReducer(int reducer, ){
