...
class Message extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Message',
  ...
  static Message getDefault() =>
      _defaultInstance ??= GeneratedMessage.$_defaultFor<Message>(create);
  ...
  @override
  factory Message.fromBuffer(List<int> i,
          [ExtensionRegistry r = ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  @override
  factory Message.fromJson(String i,
          [ExtensionRegistry r = ExtensionRegistry.EMPTY]) =>
