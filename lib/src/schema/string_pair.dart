...
class StringPair extends GeneratedMessage {
  ...
  static StringPair getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<StringPair>(create);
  ...
  factory StringPair({String? left, String? right,}) {
  ...
  @override
  factory StringPair.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);

  @override
  factory StringPair.fromJson(Map<String, dynamic> json) => StringPair(left: json["left"], right: json["right"]);
  ...
  @TagNumber(1)
  set left(String v) { $_setString(0, v); }
  @TagNumber(1)
  bool hasLeft() => $_has(0);
  @TagNumber(1)
  ...
  @TagNumber(2)
  set right(String v) { $_setString(1, v); }
  @TagNumber(2)
