...
class Secp256k1Signature extends GeneratedMessage {
  ...
  static PbList<Secp256k1Signature> createRepeated() => PbList<Secp256k1Signature>();
  static Secp256k1Signature getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<Secp256k1Signature>(create);
  ...
  @override
  Secp256k1Signature copyWith(void Function(Secp256k1Signature) updates) => super.copyWith((message) => updates(message as Secp256k1Signature)) as Secp256k1Signature; // ignore: deprecated_member_use

  @override
  Secp256k1Signature createEmptyInstance() => create();

  factory Secp256k1Signature({List<int>? der,}) {
  ...
  @override
  factory Secp256k1Signature.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  @TagNumber(1)
  set der(List<int> v) { $_setBytes(0, v); }
  @TagNumber(1)
  bool hasDer() => $_has(0);
  @TagNumber(1)
