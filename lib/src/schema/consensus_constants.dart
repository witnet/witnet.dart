...
class ConsensusConstants extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo(
    ...
    createEmptyInstance: create)
      ...
      ..a<Int64>(14, 'collateralMinimum', PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
      ...
      ..a<Int64>(24, 'initialBlockReward', PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
      ..a<int>(25, 'halvingPeriod', PbFieldType.OU3)
      ..hasRequiredFields = false;

  static ConsensusConstants create() => ConsensusConstants._();
  static PbList<ConsensusConstants> createRepeated() => PbList<ConsensusConstants>();
  static ConsensusConstants getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<ConsensusConstants>(create);
  ...
  @override
  ConsensusConstants copyWith(void Function(ConsensusConstants) updates) => super.copyWith((message) => updates(message as ConsensusConstants)) as ConsensusConstants; // ignore: deprecated_member_use
  ...
  factory ConsensusConstants({
    ...
    if (superblockCommitteeDecreasingPeriod != null) {
      _result.superblockCommitteeDecreasingPeriod = superblockCommitteeDecreasingPeriod;
    }
    if (superblockCommitteeDecreasingStep != null) {
      _result.superblockCommitteeDecreasingStep = superblockCommitteeDecreasingStep;
    }
  ...
  @override
  factory ConsensusConstants.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);

  @override
  factory ConsensusConstants.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  @TagNumber(1)
  set checkpointZeroTimestamp(Int64 v) { $_setInt64(0, v); }
  @TagNumber(1)
  ...
  @TagNumber(2)
  set checkpointsPeriod(int v) { $_setUnsignedInt32(1, v); }
  @TagNumber(2)
  ...
  @TagNumber(3)
  set bootstrapHash(Hash v) { setField(3, v); }
  @TagNumber(3)
  ...
  @TagNumber(4)
  set genesisHash(Hash v) { setField(4, v); }
  @TagNumber(4)
  ...
  @TagNumber(5)
  set maxVtWeight(int v) { $_setUnsignedInt32(4, v); }
  @TagNumber(5)
  ...
  @TagNumber(6)
  set maxDrWeight(int v) { $_setUnsignedInt32(5, v); }
  @TagNumber(6)
  ...
  @TagNumber(7)
  set activityPeriod(int v) { $_setUnsignedInt32(6, v); }
  @TagNumber(7)
  ...
  @TagNumber(8)
  set reputationExpireAlphaDiff(int v) { $_setUnsignedInt32(7, v); }
  @TagNumber(8)
  ...
  @TagNumber(9)
  set reputationIssuance(int v) { $_setUnsignedInt32(8, v); }
  @TagNumber(9)
  ...
  @TagNumber(10)
  set reputationIssuanceStop(int v) { $_setUnsignedInt32(9, v); }
  @TagNumber(10)
  ...
  @TagNumber(11)
  set reputationPenalizationFactor(double v) { $_setDouble(10, v); }
  @TagNumber(11)
  ...
  @TagNumber(12)
  set miningBackupFactor(int v) { $_setUnsignedInt32(11, v); }
  @TagNumber(12)
  ...
  @TagNumber(13)
  set miningReplicationFactor(int v) { $_setUnsignedInt32(12, v); }
  @TagNumber(13)
  ...
  @TagNumber(14)
  set collateralMinimum(Int64 v) { $_setInt64(13, v); }
  @TagNumber(14)
  ...
  @TagNumber(15)
  set collateralAge(int v) { $_setUnsignedInt32(14, v); }
  @TagNumber(15)
  ...
  @TagNumber(16)
  set superblockPeriod(int v) { $_setUnsignedInt32(15, v); }
  @TagNumber(16)
  ...
  @TagNumber(17)
  set extraRounds(int v) { $_setUnsignedInt32(16, v); }
  @TagNumber(17)
  ...
  @TagNumber(18)
  set minimumDifficulty(int v) { $_setUnsignedInt32(17, v); }
  @TagNumber(18)
  ...
  @TagNumber(19)
  set epochsWithMinimumDifficulty(int v) { $_setUnsignedInt32(18, v); }
  @TagNumber(19)
  ...
  @TagNumber(21)
  set superblockSigningCommitteeSize(int v) { $_setUnsignedInt32(20, v); }
  @TagNumber(21)
  ...
  @TagNumber(22)
  set superblockCommitteeDecreasingPeriod(int v) { $_setUnsignedInt32(21, v); }
  @TagNumber(22)
  ...
  @TagNumber(23)
  set superblockCommitteeDecreasingStep(int v) { $_setUnsignedInt32(22, v); }
  @TagNumber(23)
  ...
  @TagNumber(24)
  set initialBlockReward(Int64 v) { $_setInt64(23, v); }
  @TagNumber(24)
  ...
  @TagNumber(25)
  set halvingPeriod(int v) { $_setUnsignedInt32(24, v); }
  @TagNumber(25)
