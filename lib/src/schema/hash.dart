...
class Hash extends GeneratedMessage {
  ...
  static Hash getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<Hash>(create);
  ...
  @override
  Hash clone() {throw UnimplementedError();}
  ...
  @override
  factory Hash.fromString(String string) => Hash(SHA256: hexToBytes(string).toList());

  @override
  factory Hash.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  @TagNumber(1)
  set SHA256(List<int> v) { $_setBytes(0, v); }
  @TagNumber(1)
