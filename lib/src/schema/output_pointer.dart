...
class OutputPointer extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('OutputPointer',
  ...
  static OutputPointer getDefault() =>
      _defaultInstance ??= GeneratedMessage.$_defaultFor<OutputPointer>(create);
