...
class InventoryEntry extends GeneratedMessage {
  ...
  static InventoryEntry getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<InventoryEntry>(create);
  ...
  @override
  InventoryEntry copyWith(void Function(InventoryEntry) updates) => super.copyWith((message) => updates(message as InventoryEntry)) as InventoryEntry; // ignore: deprecated_member_use
  ...
  @override
  factory InventoryEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);

  @override
  factory InventoryEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  @TagNumber(3)
  set superBlock(int v) { $_setUnsignedInt32(2, v); }
  @TagNumber(3)
