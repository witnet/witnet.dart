...
class CheckpointBeacon extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('CheckpointBeacon',
  ...
  static PbList<CheckpointBeacon> createRepeated() =>
      PbList<CheckpointBeacon>();
  static CheckpointBeacon getDefault() => _defaultInstance ??=
      GeneratedMessage.$_defaultFor<CheckpointBeacon>(create);
  ...
  @override
  factory CheckpointBeacon.fromBuffer(List<int> i,
          [ExtensionRegistry r = ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory CheckpointBeacon.fromRawJson(String str) =>
      CheckpointBeacon.fromJson(json.decode(str));

  @override
  factory CheckpointBeacon.fromJson(Map<String, dynamic> json) =>
      CheckpointBeacon(
