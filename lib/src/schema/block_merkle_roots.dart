...
class BlockMerkleRoots extends GeneratedMessage {
  ...
  @override
  factory BlockMerkleRoots.fromBuffer(List<int> i,
          [ExtensionRegistry r = ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory BlockMerkleRoots.fromRawJson(String str) =>
      BlockMerkleRoots.fromJson(json.decode(str));

  @override
  factory BlockMerkleRoots.fromJson(Map<String, dynamic> json) =>
      BlockMerkleRoots(
  ...
  @TagNumber(4)
  set commitHashMerkleRoot(Hash v) {
    setField(4, v);
  }
  ...
  @TagNumber(5)
  set revealHashMerkleRoot(Hash v) {
    setField(5, v);
  }
  ...
  @TagNumber(6)
  set tallyHashMerkleRoot(Hash v) {
    setField(6, v);
  }
