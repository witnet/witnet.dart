...
class RevealTransaction extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('RevealTransaction',
  ...
  static PbList<RevealTransaction> createRepeated() =>
      PbList<RevealTransaction>();
  static RevealTransaction getDefault() => _defaultInstance ??=
      GeneratedMessage.$_defaultFor<RevealTransaction>(create);
  ...
  factory RevealTransaction(
      {RevealBody? body, Iterable<KeyedSignature>? signatures}) {
  ...
  @override
  factory RevealTransaction.fromBuffer(List<int> i,
          [ExtensionRegistry r = ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  @override
  factory RevealTransaction.fromJson(Map<String, dynamic> json) =>
      RevealTransaction(
