...
class DataRequestEligibilityClaim extends GeneratedMessage {
  ...
  static DataRequestEligibilityClaim create() => DataRequestEligibilityClaim._();
  static PbList<DataRequestEligibilityClaim> createRepeated() => PbList<DataRequestEligibilityClaim>();
  static DataRequestEligibilityClaim getDefault() => _defaultInstance ??= GeneratedMessage.$_defaultFor<DataRequestEligibilityClaim>(create);
  static DataRequestEligibilityClaim? _defaultInstance;

  DataRequestEligibilityClaim._() : super();

  @override
  DataRequestEligibilityClaim clone() => DataRequestEligibilityClaim()..mergeFromMessage(this);
  ...
  @override
  factory DataRequestEligibilityClaim.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
