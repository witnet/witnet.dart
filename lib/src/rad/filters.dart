...
class Filter {
  static greaterThan(num value, List<num> values) {
    return values.where((element) => (value > element)).toList();
  }

  static lessThan(num value, List<num> values) {
    return values.where((element) => (value < element)).toList();
  }

  static equals(num value, List<num> values) {
    return values.where((element) => (value == element)).toList();
  }
