...
Uint8List ripemod160({required Uint8List data}) => new RIPEMD160Digest().process(data);
Uint8List hash160({required Uint8List data})  => ripemod160(data: sha256(data: data));
Uint8List hash256({required Uint8List data}) => sha256(data: sha256(data: data));
